...
program
  ...
  .option(
    '--dangerously-skip-confirmations',
    'skip ALL confirmations, including destructive commands (use with care)',
    false,
  )
  .option('--no-animations', 'disable startup and streaming animations')
  .action((directory: string | undefined, opts: CliOptions) => {
...
interface CliOptions {
  yes?: boolean;
  dangerouslySkipConfirmations?: boolean;
  animations?: boolean;
}
